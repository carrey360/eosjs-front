...
function addPage(name, options) {
    ...
    var i18nPath = path.join(pagePath, 'i18n/index.js')
    ...
    if(fs.existsSync(i18nPath)) {
      INFO(`添加的国际化文件${i18nPath}已经存在，请去对应位置修改！`)
    } else {
        fse.ensureFileSync(i18nPath)
        writeFileFromTpl(i18nPath, path.join(inode, `tpl/i18n`), {});
    }
}
